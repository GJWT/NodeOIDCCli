...
class ServiceContext {
   ...
   * @param {Array<strings>} events List of event names
   * @param {Object<string, string>} db Refers to the State db
   * @param {string} dbName State db name
   * @param {bool} strictOnPreferences Whether the preference should be on or not
   */
